<template>
  <section id="faqMenu" class="faq-menu">
...
.faq-menu__left {
  ...
  &::before {
    ...
    top: 0;
    bottom: 0;
    background-color: color(blueScreen);
    @include respond-to(sm) {
      right: -999px;
    }
  }
